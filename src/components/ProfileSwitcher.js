...
const ProfileSwitcher = ({ showCreateNew }) => {
	...
	return (
		<div className="w-fit mt-2 flex flex-col bg-secondary px-1 py-1 rounded-lg">
					...
					{!createProfileMode && (
						<div>
							<select
								...
								className="font-main text-s px-5 rounded-lg bg-background hover:bg-secondary ml-2"
